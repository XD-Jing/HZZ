...
# Create imported target UserAnalysis::llvvPkg
add_library(UserAnalysis::llvvPkg INTERFACE IMPORTED)

set_target_properties(UserAnalysis::llvvPkg PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/src/llvv"
)

# Create imported target UserAnalysis::llvvPkgPrivate
add_library(UserAnalysis::llvvPkgPrivate INTERFACE IMPORTED)

# Create imported target UserAnalysis::llvvLib
add_library(UserAnalysis::llvvLib SHARED IMPORTED)
