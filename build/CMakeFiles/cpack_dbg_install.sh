...
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.8.1/Linux-x86_64/bin/cmake -E copy /atlas/data19/liji/HZZ/build/x86_64-slc6-gcc62-opt/bin/*.dbg \
    ${OUTDIR}/bin/
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.8.1/Linux-x86_64/bin/cmake -E copy /atlas/data19/liji/HZZ/build/x86_64-slc6-gcc62-opt/lib/*.dbg \
    ${OUTDIR}/lib/
